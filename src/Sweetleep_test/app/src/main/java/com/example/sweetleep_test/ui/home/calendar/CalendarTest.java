...
//
//public class CalendarTest extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
//
//
//    /**
...
//        private CalendarTest mActivity;
//        List<String> eventStrings = new ArrayList<String>();
//
//
//        public MakeRequestTask(CalendarTest activity, GoogleAccountCredential credential) {
//
//            mActivity = activity;
//
...
//
//            String ids = getCalendarID(getString(R.string.calendar_title));
//
//            if (ids != null) {
//
